...
10. クリップボードからの貼り付け
11. 回転・反転
12. 設定ファイルの読み書き（%APPDATA%）

### Phase 3: 応用機能
13. スライドショーと画像先読み（マルチスレッド）
14. クロップ・リサイズ・黒塗り
15. 大サイズ画像（8K 超）のタイリング対応
16. アニメーション GIF / WebP / AVIF の再生

### Phase 4: 最適化・拡張
17. libjpeg-turbo のオプショナル同梱
18. HDR 対応（DXGI SwapChain 移行）
19. 追加フォーマット対応の検討（ライセンスを精査の上）
