...
現在活発に開発中です。閲覧・編集の主要機能は動作します（アニメーション再生と 16K 超の巨大画像は未対応）。 / Under active development; the main viewing and editing features work (animation playback and images beyond 16K are not supported yet).
